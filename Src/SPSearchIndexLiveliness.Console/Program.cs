...
namespace Holm.SPSearchIndexLiveliness.Console {
    class Program {
        ...
        static void UpdateResults(List<DateTime> receivedPings, int run) {
            ...
            if (run == 0) {
                System.Console.WriteLine("Run\tReplies\t\tCurrent time\t\tMost recent reply\tLatency");
            }
        ...
        static void Main(string[] args) {
            if (args.Length < 3 && args.Length != 5) {
                System.Console.WriteLine("SPSearchIndexLiveliness.Console.exe webUrl listTitle pingInterval [username] [password]");
                System.Console.WriteLine("SPSearchIndexLiveliness.Console.exe https://bugfree.sharepoint.com/sites/liveliness Pings 30 rh@bugfree.onmicrosoft.com password");
                return;
            }
